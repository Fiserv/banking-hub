...
| API Name | Description | Environment Availability |
| -------- | ----------- | ------------------------ |
| <a href="../api/?type=put&path=/beneficiaryservice/partyacctsvc/beneficiaries&branch" title="Click to open"> Update Beneficiary</a> |  <span style="font-size: small; color: gray; font-style: italic; text-align: right; display: block;">FETP-3801</span> We resolved the error returned in the response when the 'AddressIdent' field value exceeds five digits in the request. | CERT | <!-- <!-- FETP-3801 CERT as on 16 Oct 24. -->
