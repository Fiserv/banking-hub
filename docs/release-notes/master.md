...
| <a href="../api/?type=post&path=/xferservice/payments/transfers" title="Click to open">Add Transfer</a> | We resolved an issue where the users were not able to make payment for loan from another loan account.  | CERT |
