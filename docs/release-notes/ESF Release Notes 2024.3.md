...
| -------- | ----------- |
| Add Account Hold | We resolved the error "**Stop Pay Date Date Cannot be a Future Date**" that occured while adding a stop check instruction in the request with no value set for the stop check date. | <!-- ESFATIG-2708 --> 
