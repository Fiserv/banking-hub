...
| -------- | ----------- | ------------------------ |
| <a href="../api/?type=post&path=/xferservice/payments/transfers/secured" title="Click to open">Get Transfer</a> | We resolved the issue where the `DayOfMonth` field was not mapped correctly.<br>**Impacted Field:** <br> `XferRec/XferInfo/RecurModel/RecurRule/DayOfMonth`| CERT |
