# Implementation Notes for Inq Collatral
...
|`CollateralRec.CollateralInfo.CollateralType`|Basic<br>Vehicle<br>Property<br>OtherProperty<br>Other<br>LifeInsurance<br>DepositAccount<br>Commodity<br><br>|Please note by default the collateral type will be Basic, unless the institution is set to allow other collateral types. |
...
|`CollateralRec.CollateralInfo.CollateralInsuranceData.CoveragePremiumAmt.Amt`|| |
