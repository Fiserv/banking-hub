...
|`ePreferenceInfo.NoticeData.NoticeOption`|NoNotice|Applicable for additional ePreference records.<br><br>EimOption is not available for CDA account type in multiple mailing addendas.|
...
|`ePreferenceInfo.EmailLink.Email.EmailType`|Business<br>Person<br>|***Conditionally Required**<br>Required to be provided to specify the type when email address is sent in the request|
