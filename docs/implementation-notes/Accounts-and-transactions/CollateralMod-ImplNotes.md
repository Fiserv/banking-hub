...
|----|----|----|
|`CollateralKeys`|| |
|`CollateralKeys.CollateralId`||***Required**<br>Required for modification operation.|
|`CollateralInfo`|| |
